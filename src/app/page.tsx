                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-6 max-w-6xl mx-auto">
                        ...
                        <motion.div
                            ...
                            className="relative overflow-hidden flex flex-col items-center justify-center p-6 text-center rounded-[2rem] border border-border/50 shadow-xl shadow-black/5 bg-gradient-to-br from-[#2b579a] to-[#0078d4] group hover:-translate-y-2 transition-transform duration-300"
                        >
                            <div className="bg-white/20 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4 shadow-sm flex items-center gap-2">
                                ...
                                <span className="font-bold text-white tracking-tight">Microsoft</span>
                            </div>
                            <p className="text-white/80 text-xs mb-1">Data & AI • Azure</p>
                            <h4 className="text-white font-bold text-lg mb-1 leading-none">Solutions</h4>
                            <p className="text-white/80 text-xs tracking-widest uppercase">partner</p>
                            <div className="flex gap-1 mt-2">{[1, 2, 3].map(s => <span key={s} className="text-yellow-400 text-xs">★</span>)}</div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="relative overflow-hidden flex flex-col items-center justify-center p-6 text-center rounded-[2rem] border border-border/50 shadow-xl shadow-black/5 bg-gradient-to-br from-[#232f3e] to-[#37475a] group hover:-translate-y-2 transition-transform duration-300"
                        >
                            <div className="bg-white/20 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4 shadow-sm">
                                <span className="font-bold text-white tracking-tight">aws</span>
                            </div>
                            <p className="text-white/80 text-xs mb-1">Amazon EMR Delivery</p>
                            <h4 className="text-white font-bold text-lg mb-1 leading-none">Advanced</h4>
                            <p className="text-white/80 text-xs tracking-widest uppercase">partner</p>
                            <div className="flex gap-1 mt-2">{[1, 2, 3].map(s => <span key={s} className="text-yellow-400 text-xs">★</span>)}</div>
                        </motion.div>
                    </div>
