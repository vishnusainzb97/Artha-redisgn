            ...
            <div className="container mx-auto px-6">
                ...
                <div className="mb-24">
                    ...
                    <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {events.map((evt, i) => (
                            <motion.div variants={item} key={i} className="glass-card p-6 rounded-3xl flex gap-6 items-start group hover:border-primary-500 transition-colors">
                ...
                {/* WHITE PAPERS SECTION (Bento Grid) */}
                <div className="mb-24">
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <h2 className="text-3xl font-heading font-bold">Featured Research</h2>
                    </div>
